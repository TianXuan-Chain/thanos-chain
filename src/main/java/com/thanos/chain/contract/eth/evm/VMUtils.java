...
public final class VMUtils {
    ...
    private static File createProgramTraceFile(SystemConfig config, String txHash) {
        File result = null;
    ...
    public static void saveProgramTraceFile(SystemConfig config, String txHash, String content) {
