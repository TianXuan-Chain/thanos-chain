 ...
 */
package com.thanos.chain.contract.eth.evm.trace;
...
import com.thanos.chain.contract.eth.evm.OpCode;
...
import static com.thanos.chain.contract.eth.evm.trace.Serializers.serializeFieldsOnly;
...
public class ProgramTrace {
    ...
    public ProgramTrace(SystemConfig config, ProgramInvoke programInvoke) {
