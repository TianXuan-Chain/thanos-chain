...
import static com.thanos.chain.contract.eth.evm.OpCode.Tier.*;
...
public enum OpCode {
    ...
    /**
     * (0x3f) Returns the keccak256 getHash of
     * a contract’s code
     */
    ...
    /**
     * (0x40) Get getHash of most recent
     * complete block
     */
    ...
    /**
     * (0x47) Get the balance of recipient address
     */
    SELFBALANCE(0x47, 0, 1, BaseTier),

    /**
     * (0x48) Get the block header base free
     */
    BASEFEE(0x48, 0, 1, BaseTier),
