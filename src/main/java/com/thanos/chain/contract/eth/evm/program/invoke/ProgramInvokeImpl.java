...
public class ProgramInvokeImpl implements ProgramInvoke {
    ...
    private DataWord difficulty = DataWord.of(BigInteger.ZERO.toByteArray());
    private DataWord gaslimit = DataWord.of(new BigInteger("10000000").toByteArray());
    /**
     * TRANSACTION  env **
     */
    ...
    public ProgramInvokeImpl(byte[] address, byte[] origin, byte[] caller, byte[] balance,
        ...
        DataWord zero = DataWord.of(ByteUtil.copyFrom(DataWord.ZERO.getData()));
        // EthTransaction env
