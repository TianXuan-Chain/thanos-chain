...
public class PingMessage extends DiscoveryMessage {
    ...
    public static PingMessage create(Node fromNode, Node toNode, SecureKey privKey) {
        return create(fromNode, toNode, privKey, 4);
    }

    public static PingMessage create(Node fromNode, Node toNode, SecureKey privKey, int version) {
