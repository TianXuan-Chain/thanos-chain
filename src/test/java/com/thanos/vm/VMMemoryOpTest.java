...
import static com.thanos.common.utils.ByteUtil.oneByteToHexString;
...
public class VMMemoryOpTest extends VMBaseOpTest {
    private static final SystemConfig constantinopleConfig = new SystemConfig(){{
        //setBlockchainConfig(new TestNetConfig());
    }};
    ...
    public void testSSTORE_1() {
        ...
        DataWord val = program.getRepository().getStorageValue(invoke.getOwnerAddress()
    ...
    public void testSSTORE_NET_1() {
        ...
        assertEquals(14, program.getResult().getGasUsed());
    ...
    public void testSSTORE_NET_16() {
        ...
        assertEquals(21, program.getResult().getGasUsed());
        assertEquals(0, program.getResult().getFutureRefund());
    }
