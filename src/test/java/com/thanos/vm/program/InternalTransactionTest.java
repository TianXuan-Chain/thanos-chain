...
//
//        byte[] encoded = new InternalEthTransaction(parentHash, deep, index, nonce, gasPrice, gasLimit, sendAddress, receiveAddress, value, data, null, note).getEncoded();
//
//        InternalEthTransaction tx = new InternalEthTransaction(encoded);
//
//        assertEquals(deep, tx.getDeep());
//        assertEquals(index, tx.getIndex());
//        assertArrayEquals(parentHash, tx.getPreEventId());
...
//        assert tx.getExecuteStates().isGlobalNodeEventsEmpty();
