...
import com.thanos.chain.contract.eth.evm.program.invoke.ProgramInvokeMockImpl;
import org.junit.*;
...
public class VMCustomTest {
    ...
    @Test(expected = IndexOutOfBoundsException.class) // CALLDATACOPY OP mal
